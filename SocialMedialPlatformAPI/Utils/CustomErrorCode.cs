...
public class CustomErrorCode
{
    ...
    public const string SendMessageError = "MESSAGE_SENDING_ERROR";
    public const string StoryError = "STORY_UPLOAD_ERROR";
    public const string GetStoryError = "STORY_GET_ERROR";
    public const string StoryDeleteError = "STORY_DELETE_ERROR";
    public const string GetMessageError = "MESSAGE_NOT_FOUND";
    ...
    public const string IsNotExist = "USER_NOT_EXITS";
    ...
    public const string IsProfile = "NO_PROFILE";

    public const string IsRemoveMessage = "Remove_Message_Error";
}
